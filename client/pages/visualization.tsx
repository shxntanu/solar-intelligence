...
function Visualization() {
    ...
    const [showApi, setShowApi] = useState("api/global");
        ...
        if (region === "global") {
            ...
            if (
                ...
                ApiService.get(
                    ...
                    setData(convertResponseToFormattedData(res.data));
                    setShowApi(
                        `api/region/${state}/${category}/${numericData}`
                    );
                });
            } else if (category && category !== "None") {
    ...
    return (
        <div>
            ...
            <p className="flex items-center justify-center">
                This is where Solar Panel business owners can visualise data and

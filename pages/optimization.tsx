    ...
    return (
        <div>
            ...
            <p className="flex items-center justify-center text-center">
                This is where, for a given user ID, the user is recommended 5 of
                their nearest neighbours <br /> using K Means Clustering to see
                how they are performing relative to them
            </p>

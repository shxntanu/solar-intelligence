  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center pb-5">
        ...
        <p>
          This is where Sarpanchs of Villages and Gram Panchayats can add their
          respective villages to our database
        </p>
      </div>
      <div className="grid grid-cols-2 w-3/4 space-x-5">
        <Card className="p-5 col-span-1">
          <div className="space-y-5">
            ...
            <Input label="Village Name" placeholder="Enter your village name" />
        ...
        <Card className="p-5 col-span-1">
          <div className="space-y-5">
            ...
            <Checkbox>
              Do you use renewable energy solutions in your village
            </Checkbox>
            <Checkbox>
              Do you plan to you use renewable energy solutions in your village?
            </Checkbox>
            <h1 className=" font-bold">Current Village Energy Sources</h1>
            <Input
